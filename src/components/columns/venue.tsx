        ...
        cell: ({row}) => {
            ...
            return (
                <div className="flex space-x-2">
                    <Link to={`/venue/view/${id}`} className="bg-blue-500 text-white px-2 py-2 rounded-md hover:scale-110 cursor-pointer"><Eye /> </Link>
                    <Link to={`/venue/edit/${id}`} className="bg-orange-500 text-white px-2 py-2 rounded-md hover:scale-110 cursor-pointer"><SquarePen /> </Link>
